...
# =========================================================
# BLACK CLOVER - personagens
# =========================================================
# estado: "vivo", "morto" ou "desconhecido"
# esquadrao: alvorecer_dourado, touros_negros, aguias_prata,
#            leoes_carmesins, rosa_azul, louva_deus_verdes,
#            orcas_purpuras, pavao_coral, cervo_ciano,
#            nenhum, demonio, elfo
# =========================================================
...
PERSONAGENS = [
    ...
    # ---------- ALVORECER DOURADO ----------
    {"nome": "Yuno", "cabelo": "preto", "olhos": "negros", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "vento", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "William Vangeance", "cabelo": "loiro", "olhos": "azuis", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "arvore", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Langris Vaude", "cabelo": "loiro", "olhos": "azuis", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "espacial", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Klaus Lunettes", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "aco", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Mimosa Vermillion", "cabelo": "loiro", "olhos": "verdes", "altura": "medio", "idade": "jovem", "genero": "feminino", "origem": "clover", "poder": "plantas", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Alecdora Sandler", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "areia", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Hamon Caseus", "cabelo": "castanho", "olhos": "castanhos", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "vidro", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Shiren Tium", "cabelo": "preto", "olhos": "negros", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "rocha", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},
    {"nome": "Letoile Becquerel", "cabelo": "loiro", "olhos": "azuis", "altura": "medio", "idade": "jovem", "genero": "feminino", "origem": "clover", "poder": "bussola", "arma": "grimorio", "estado": "vivo", "esquadrao": "alvorecer_dourado"},

    # ---------- ÁGUIAS DE PRATA ----------
    {"nome": "Nozel Silva", "cabelo": "prateado", "olhos": "roxos", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "mercurio", "arma": "grimorio", "estado": "vivo", "esquadrao": "aguias_prata"},
    {"nome": "Nebra Silva", "cabelo": "prateado", "olhos": "roxos", "altura": "medio", "idade": "jovem", "genero": "feminino", "origem": "clover", "poder": "nevoa", "arma": "grimorio", "estado": "vivo", "esquadrao": "aguias_prata"},
    {"nome": "Solid Silva", "cabelo": "prateado", "olhos": "azuis", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "agua", "arma": "grimorio", "estado": "vivo", "esquadrao": "aguias_prata"},

    # ---------- REIS LEÕES CARMESINS ----------
    {"nome": "Fuegoleon Vermillion", "cabelo": "vermelho", "olhos": "vermelhos", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "fogo", "arma": "grimorio", "estado": "vivo", "esquadrao": "leoes_carmesins"},
    {"nome": "Mereoleona Vermillion", "cabelo": "vermelho", "olhos": "vermelhos", "altura": "alto", "idade": "adulto", "genero": "feminino", "origem": "clover", "poder": "fogo", "arma": "punhos", "estado": "vivo", "esquadrao": "leoes_carmesins"},
    {"nome": "Leopold Vermillion", "cabelo": "vermelho", "olhos": "vermelhos", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "fogo", "arma": "grimorio", "estado": "vivo", "esquadrao": "leoes_carmesins"},
    {"nome": "Kirsch Vermillion", "cabelo": "vermelho", "olhos": "vermelhos", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "cerejeira", "arma": "grimorio", "estado": "vivo", "esquadrao": "leoes_carmesins"},
    {"nome": "Randall Luftair", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "vento", "arma": "grimorio", "estado": "vivo", "esquadrao": "leoes_carmesins"},
    ...
    # ---------- LOUVA-A-DEUS VERDES ----------
    {"nome": "Jack The Ripper", "cabelo": "preto", "olhos": "verdes", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "corte", "arma": "grimorio", "estado": "vivo", "esquadrao": "louva_deus_verdes"},
    {"nome": "Sekke Bronzazza", "cabelo": "castanho", "olhos": "castanhos", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "bronze", "arma": "grimorio", "estado": "vivo", "esquadrao": "louva_deus_verdes"},
    {"nome": "En Ringard", "cabelo": "verde", "olhos": "verdes", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "fungo", "arma": "grimorio", "estado": "vivo", "esquadrao": "louva_deus_verdes"},

    # ---------- CERVO CIANO ----------
    {"nome": "Rill Boismortier", "cabelo": "loiro", "olhos": "azuis", "altura": "baixo", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "pintura", "arma": "grimorio", "estado": "vivo", "esquadrao": "cervo_ciano"},
    {"nome": "Fragil Tormenta", "cabelo": "loiro", "olhos": "azuis", "altura": "baixo", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "neve", "arma": "grimorio", "estado": "vivo", "esquadrao": "cervo_ciano"},
    {"nome": "Walter", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "gelo", "arma": "grimorio", "estado": "vivo", "esquadrao": "cervo_ciano"},

    # ---------- PAVÕES CORAIS ----------
    {"nome": "Dorothy Unsworth", "cabelo": "loiro", "olhos": "azuis", "altura": "baixo", "idade": "adulto", "genero": "feminino", "origem": "clover", "poder": "sonho", "arma": "grimorio", "estado": "vivo", "esquadrao": "pavoes_corais"},
    {"nome": "Rick Cornell", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "calor", "arma": "grimorio", "estado": "vivo", "esquadrao": "pavoes_corais"},
    {"nome": "Demitri Brint", "cabelo": "preto", "olhos": "negros", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "sangue", "arma": "grimorio", "estado": "vivo", "esquadrao": "pavoes_corais"},

    # ---------- ORCAS PÚRPURAS ----------
    {"nome": "Kaiser Granvorka", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "vento", "arma": "grimorio", "estado": "vivo", "esquadrao": "orcas_purpuras"},
    {"nome": "Gueldre Poizot", "cabelo": "loiro", "olhos": "azuis", "altura": "alto", "idade": "adulto", "genero": "masculino", "origem": "clover", "poder": "veneno", "arma": "grimorio", "estado": "morto", "esquadrao": "orcas_purpuras"},
    {"nome": "Xerx Lügner", "cabelo": "castanho", "olhos": "castanhos", "altura": "medio", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "vento", "arma": "grimorio", "estado": "vivo", "esquadrao": "orcas_purpuras"},
    {"nome": "Digit Taliss", "cabelo": "castanho", "olhos": "castanhos", "altura": "alto", "idade": "jovem", "genero": "masculino", "origem": "clover", "poder": "gelo", "arma": "grimorio", "estado": "morto", "esquadrao": "orcas_purpuras"},
...
GRUPOS = {
    ...
    "esquadrao": {
        ...
        "alvorecer": ["alvorecer_dourado"],
        "aguias": ["aguias_prata"],
        "leoes": ["leoes_carmesins"],
        "rosa": ["rosa_azul"],
        "louva": ["louva_deus_verdes"],
        "orcas": ["orcas_purpuras"],
        "pavoes": ["pavoes_corais"],
        "cervo": ["cervo_ciano"],
...
CARACTERISTICAS_EXTRA = ["estado", "esquadrao"]
...
VALORES_BONITOS = {
    # Esquadrões
    "alvorecer_dourado": "Alvorecer Dourado",
    "touros_negros": "Touros Negros",
    "aguias_prata": "Águias de Prata",
    "leoes_carmesins": "Reis Leões Carmesins",
    "rosa_azul": "Rosa Azul",
    "louva_deus_verdes": "Louva-a-Deus Verdes",
    "orcas_purpuras": "Orcas Púrpuras",
    "pavoes_corais": "Pavões Corais",
    "cervo_ciano": "Cervo Ciano",
...
def procurar(termo):
    ...
    todos = sorted(PERSONAGENS, key=lambda p: normalizar(p["nome"]))

    if not termo_norm:
        return [p["nome"] for p in todos]

    return [
        p["nome"] for p in todos
